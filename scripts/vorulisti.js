...
function fetchProductDetails(productId) {
  fetch(
    `https://vef1-2023-h2-api-791d754dda5b.herokuapp.com/products/${productId}`
  )
...
function fetchSimilarProducts(category) {
  fetch(
    `https://vef1-2023-h2-api-791d754dda5b.herokuapp.com/products?limit=3&category=${category}`
  )
    .then((response) => response.json())
